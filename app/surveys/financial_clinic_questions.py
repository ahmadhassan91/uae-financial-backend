...
FINANCIAL_CLINIC_QUESTIONS: List[FinancialClinicQuestion] = [
    ...
    FinancialClinicQuestion(
        ...
        options=[
                            ...
                            FinancialClinicOption(value=4, label_en="15% to 20% of my income", label_ar="15% من دخلي إلى 20%"),  # Fixed Arabic format
                        FinancialClinicOption(value=3, label_en="5% to 15% of my income", label_ar="5% من دخلي إلى 15%"),  # Fixed Arabic format
                        FinancialClinicOption(value=2, label_en="Up to 5% of my income", label_ar="حتى ٪٥ من دخلي"),
