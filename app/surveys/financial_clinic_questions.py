...
FINANCIAL_CLINIC_QUESTIONS: List[FinancialClinicQuestion] = [
    ...
    FinancialClinicQuestion(
        ...
        options=[
                            ...
                            FinancialClinicOption(value=4, label_en="15% to 20% of my income", label_ar="من 15٪ إلى 20٪ من دخلي"),
                        FinancialClinicOption(value=3, label_en="5% to 15% of my income", label_ar="من 5٪ إلى 15٪ من دخلي"),
