...
FINANCIAL_CLINIC_QUESTIONS: List[FinancialClinicQuestion] = [
    ...
    FinancialClinicQuestion(
        ...
        options=[
              ...
              FinancialClinicOption(value=4, label_en="I stay as within my budget every month", label_ar="أنا ألتزم بميزانيتي كلّ شهر"),
    ...
    FinancialClinicQuestion(
        ...
        options=[
              FinancialClinicOption(value=5, label_en="I already have a sufficient emergency savings", label_ar="مدخرات الطوارئ الخاصة بي كافية بالفعل"),
    ...
    FinancialClinicQuestion(
        ...
        options=[
              FinancialClinicOption(value=5, label_en="In my savings or current bank account", label_ar="في  صكوك الادخار /حسابي المصرفي، الادخاري أو الجاري"),
    ...
    FinancialClinicQuestion(
        ...
        options=[
            FinancialClinicOption(value=5, label_en="Yes, I contribzute regularly for a retirement plan and with a specific goal", label_ar="نعم، أساهم بانتظام في خطة تقاعد ولدي خطة مستقرة"),
