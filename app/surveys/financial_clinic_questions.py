...
FINANCIAL_CLINIC_QUESTIONS: List[FinancialClinicQuestion] = [
    ...
    FinancialClinicQuestion(
        ...
        options=[
            ...
            FinancialClinicOption(value=4, label_en='15% to 20% of my income', label_ar='\u200e20%\u200e من دخلي إلى \u200e15%\u200e'),
            FinancialClinicOption(value=3, label_en='5% to 15% of my income', label_ar='\u200e15%\u200e من دخلي إلى \u200e5%\u200e'),
            FinancialClinicOption(value=2, label_en='Up to 5% of my income', label_ar='\u2067حتى \u206650%\u2069 من دخلي\u2069'),
    ...
    FinancialClinicQuestion(
        ...
        weight=5,  # 5% of total score
        text_en='Do you have adequate savings or life takaful/insurance coverage for your family?',
        text_ar='هل لديكم مدخرات أو تأمين تكافلي/تأمين على الحياة يوفّر تغطية كافية لعائلتكم؟',
        options=[
    ...
    FinancialClinicQuestion(
        ...
        category=FinancialClinicCategory.PROTECTING_FAMILY,
        weight=5,  # 5% of total score
        text_en='Do you currently have sufficient education savings for your children?',
        text_ar='هل لديكم ما يكفي لتغطية نفقات تعليم أبنائكم؟',
        options=[
            ...
            FinancialClinicOption(value=4, label_en="I have sufficient funds for my children's education", label_ar=' لديّ أموال كافية لتعليم أبنائي'),
            FinancialClinicOption(value=3, label_en='I am saving towards having a sufficient education fund', label_ar='ادّخر من أجل توفير تمويل كافٍ لتعليم أبنائي'),
            FinancialClinicOption(value=2, label_en='I am starting to save for an education fund', label_ar='لقد بدأت بالادخار من أجل تمويل تعليم أبنائي'),
            FinancialClinicOption(value=1, label_en='I do not have any education saving for my children', label_ar='ليس لديّ أيّ مدخرات مخصّصة لتعليم أبنائي'),
        ],
        conditional=True,
