...
def main():
    """Fix all Python files in the app directory only."""
    app_dir = Path("/home/clustox/Desktop/UAE-FC/financialclinic-backend/app")
    fixed_count = 0
    ...
    print(f"\nFixed {fixed_count} files in app directory")
